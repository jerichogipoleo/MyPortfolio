...
const Contact = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col font-montserrat">
      <Nav />
      <div className="aboutcontainer1 text-white">
        <div className="container mx-auto flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-4 md:mb-8">
            ...
            <div className="bgcolor rounded-lg p-4 flex items-center hover:bg-red-900">
              ...
              <div className="ml-4">
                <h2 className="text-sm md:text-lg font-bold ">Social Media</h2>
                <p className="text-xs md:text-sm">
          ...
          <div className="bgcolor p-4 rounded-lg shadow-md">
            ...
            >
              <div className="mb-4">
                <input
                  className="w-full p-2 border rounded-md text-xs md:text-sm  text-black"
                  type="text"
                  id="name"
                  name="name"
                  placeholder="Name"
